...
class KemonoCrawler(Crawler):
    ...
    async def handle_direct_link(self, scrape_item: ScrapeItem) -> None:
        ...
        download_sequence_number = self.download_counter.increment()
        formatted_sequence_number = f'{download_sequence_number:05}'
        filename = f'{formatted_sequence_number}.{ext}'
