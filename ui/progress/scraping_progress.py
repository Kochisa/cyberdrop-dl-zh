...
class ScrapingProgress:
    ...
    def __init__(self, visible_tasks_limit: int, manager: 'Manager'):
        ...
        self.overflow_task_id = self.overflow.add_task(self.overflow_str.format(color=self.color, number=0), visible=False)
        self.queue_task_id = self.queue.add_task(self.queue_str.format(color=self.color, number=0), visible=False)
