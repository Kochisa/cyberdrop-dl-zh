...
class DownloadsProgress:
    ...
    def __init__(self):
        ...
        self.previously_completed_files_task_id = self.progress.add_task("[yellow]已下载", total=0)
        self.previously_completed_files = 0
        self.skipped_files_task_id = self.progress.add_task("[yellow]配置中跳过", total=0)
